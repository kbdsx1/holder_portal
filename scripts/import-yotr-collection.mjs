...
/**
 * Import KBDS YOTR Collection
 * Fetches NFTs from the YOTR collection and populates the nft_metadata table
...
const COLLECTION_ADDRESS = '6pAZ3F1ExqRvygjwQHWpUMEo8XCPTg9dkdCHh1bpPpoi';
const COLLECTION_SYMBOL = 'KBDS_YOTR';
...
// Note: YOTR uses "Nomad" instead of "None"
// YOTR also uses "The Underground", "The Outer", and "Steamtown" variations
const BURROW_MAPPING = {
  ...
  'Steamtown': 'Stream Town',
  'Steam Town': 'Stream Town',
  'Jabberjaw': 'Jabberjaw',
  'Nomad': 'Nomad'
};
...
async function fetchCollectionNFTs() {
  ...
  console.log(`\n🔍 Fetching NFTs for YOTR collection (${COLLECTION_ADDRESS})...\n`);
 ...
 */
async function main() {
  console.log('🚀 Starting KBDS YOTR Collection Import\n');
