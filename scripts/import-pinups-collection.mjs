...
/**
 * Import KBDS Pinups Collection
 * Fetches NFTs from the Pinups collection and populates the nft_metadata table
...
const COLLECTION_ADDRESS = 'EDATZxGB6JdYYRQ1QQNZZXCVs1xepcVovKTJfuhbPwuR';
const COLLECTION_SYMBOL = 'KBDS_PINUPS';
...
const BURROW_MAPPING = {
  ...
  'Jabberjaw': 'Jabberjaw',
  'None': 'None',
  // Handle variations found during import
...
async function fetchCollectionNFTs() {
  ...
  console.log(`\n🔍 Fetching NFTs for Pinups collection (${COLLECTION_ADDRESS})...\n`);
 ...
 */
async function main() {
  console.log('🚀 Starting KBDS Pinups Collection Import\n');
